...
- (void)drawRect:(CGRect)rect {
    ...
    CAGradientLayer * allGradientLayer = [CAGradientLayer layer];
    
    CAGradientLayer * leftGradientLayer = [CAGradientLayer layer];
    leftGradientLayer.frame = self.bounds;
    leftGradientLayer.startPoint = CGPointMake(0, 0);
    leftGradientLayer.endPoint = CGPointMake(0.5, 1.0);
    leftGradientLayer.colors = @[(id)[UIColor redColor].CGColor, (id)[UIColor yellowColor].CGColor];
    [allGradientLayer addSublayer:leftGradientLayer];
    [self.layer addSublayer:allGradientLayer];
    [allGradientLayer setMask:shapLayer];
